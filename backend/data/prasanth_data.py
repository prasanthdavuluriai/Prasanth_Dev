# Prasanth Davuluri - Automotive Specialist Portfolio Data
...
DEFAULT_PROFILE = {
    ...
    "github": "prasanth-dev",
    "bio": "Accomplished Automotive Systems Engineer with 13+ years of expertise in embedded systems, AUTOSAR, and model-based development. Proven track record in delivering mission-critical automotive solutions for Ford, Stellantis, and Lucid Motors. Expert in MIL/SIL/HIL validation, test automation, and advanced driver assistance systems.",
    "yearsExperience": 13,
...
DEFAULT_EXPERIENCE = [
    ...
    },
    {
        ...
        "achievements": [
            ...
            "Managed offshore team and provided technical leadership across multiple releases"
        ],
...
DEFAULT_PROJECTS = [
    ...
    },
    {
        ...
        "features": [
            ...
            "Pre-integration and factory build testing"
        ],
        "status": "Completed", 
        "timeline": "2011 - 2017",
...
DEFAULT_AWARDS = [
    ...
    },
    {
        ...
        "organization": "Tata Consultancy Services", 
        "year": "2021",
        "description": "Team recognition for exceptional collaborative performance and outstanding contribution to organizational success."
    },
    {
        "id": "award-6",
        "title": "Best Team Award",
        "organization": "Tata Consultancy Services",
        "year": "2018",
        "description": "Second Best Team Award recognizing continued excellence in team collaboration and project delivery."  
    }
]
