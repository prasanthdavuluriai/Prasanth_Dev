...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-800/60 border-t border-slate-700/50 backdrop-blur-sm">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((link, index) => (
                <a
                  ...
                  className="bg-slate-700/50 text-slate-300 p-3 rounded-lg hover:bg-cyan-400/20 hover:text-cyan-400 transition-all duration-300"
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-gray-100 font-semibold text-lg mb-4">Get In Touch</h3>
